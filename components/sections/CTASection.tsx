export default function CTASection() {
  return (
    <section id="contacto" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(139,92,246,0.3),transparent_70%)]" />

      <div className="container mx-auto px-6 text-center relative z-10">
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-display font-bold mb-6 tracking-tight text-white">
          La puerta está abierta.
        </h2>
        <p className="text-purple-200/80 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          ¿Listo para dejar de operar y empezar a dirigir? Conversemos sobre cómo la IA puede transformar tu operación.
        </p>
